...
use Produtos\Http\Requests\Auth\LoginRequest;
use Produtos\Http\Requests\Auth\RegisterRequest;
use Produtos\Repositories\UserRepository;
use Produtos\Jobs\SendMail;
